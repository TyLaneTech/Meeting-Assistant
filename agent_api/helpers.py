...
SETTINGS_DESCRIPTIONS: dict[str, str] = {
    ...
    "chapters_regen_after_meeting": "Rebuild a recording's chapters once when it stops, from the finished transcript. The live runs keep the chapters they already placed, so without this the opening chapters stay as they were chosen minutes into the meeting.",
